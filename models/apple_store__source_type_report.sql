...
joined as (
    ...
    select 
        ...
        coalesce(app_store_source_type.impressions_unique_device, 0) as impressions_unique_device,
        coalesce(app_store_source_type.page_views, 0) as page_views,
        coalesce(app_store_source_type.page_views_unique_device, 0) as page_views_unique_device,
        ...
        coalesce(usage_source_type.active_devices_last_30_days, 0) as active_devices_last_30_days,
