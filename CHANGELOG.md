...
## Bug Fix
- Fixes `int_apple_store__date_spine` compilation errors when the underlying `APP_STORE_*` sources are empty or contain no data, falling back to a default one-year date range.
